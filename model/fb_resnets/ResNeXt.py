...
class ResNext(nn.Module):
    ...
    def __init__(self, block, layers, groups=1, width_per_group=64, dropout=None, num_classes=1000, use_norm=False, reduce_dimension=False, layer3_output_dim=None, layer4_output_dim=None, returns_feat=False, s=30, classifier='linear'):
        self.inplanes = 64
