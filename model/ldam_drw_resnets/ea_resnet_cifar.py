...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_experts, num_classes=10, reduce_dimension=False, layer2_output_dim=None, layer3_output_dim=None, top_choices_num=5, pos_weight=20, share_expert_help_pred_fc=True, force_all=False, use_norm=False, s=30, classifier='linear'):
        ...
        self.classifiers = nn.ModuleList([get_classifier(classifier, layer3_output_dim * block.expansion, num_classes, use_norm) for _ in range(num_experts)])
