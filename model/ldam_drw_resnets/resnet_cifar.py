...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10, reduce_dimension=False, layer2_output_dim=None, layer3_output_dim=None, use_norm=False, returns_feat=False, s=30, classifier='linear'):
        ...
        self.classifier = get_classifier(classifier, layer3_output_dim * block.expansion, num_classes, use_norm)
